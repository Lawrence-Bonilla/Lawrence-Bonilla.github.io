...
function Algorithms() {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p className="mb-4">
        By making these enhancements, I demonstrated the ability to analyze and optimize algorithms within a real web application context. This work directly ties to the program’s outcome of solving problems using algorithmic principles and managing trade-offs (Outcome 3). It also shows use of industry-relevant techniques (Outcome 4), since features like pagination and caching are common in production systems for improving scalability. 
      </p>
      <p className="mb-4">
