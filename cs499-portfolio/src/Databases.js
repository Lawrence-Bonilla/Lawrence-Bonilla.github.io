...
function Databases() {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p className="mb-4">
        From a learning perspective, this enhancement addressed the program outcomes related to applying well-founded tools/techniques and developing a security mindset. Ensuring data integrity and consistency is a critical aspect of security, for example, preventing overbookings or corrupted data is not just a functional improvement but also builds user trust. I also practiced professional communication by thoroughly documenting these database design decisions and their rationale.
      </p>
      <p className="mb-4">
